...
'Count row 2 until the end of the sheet
...
Dim WorkSheet As WorkSheet
    ...
    WorkSheet.Activate
        ...
        YCLastRow = WorkSheet.Cells(Rows.Count, Column + 8).End(xlUp).Row
        
        ' Set the Cell Colors 3 = Red 10 = Green
